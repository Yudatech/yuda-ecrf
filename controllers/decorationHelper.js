...
const getEvacuationFollowupStatusConfig = require('../config/evacuation/getEvacuationFollowupStatusConfig');
...
module.exports = {
  ...
  getEvacuationFollowupStatusConfig: getEvacuationFollowupStatusConfig,
};
